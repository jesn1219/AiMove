...
# Play sound in freight
#os.system("sshpass -p robotics ssh fetch@192.168.50.29 '~/sounds/play_sound1.sh'")
...
class BlitzFollower:
    ...
    def follow_person(self):
        ...
        rospy.Subscriber('/camera/rgb/image_rect_color', Image, self.rgb_callback)
        rospy.Subscriber('/camera/depth/image_raw', Image, self.depth_callback)
        start = time.time()

        # tmp failure exploration
        missed_count = 0
        # lin & ang velocity of the published cmd_vel topic
        lin = 0.; ang = 0.;
        ...
        while time.time() - start < self.time_limit:
            ...
            if person_img is None or box_info is None or depth_img is None:
                ...
                self.base_move_publish(0.0, 2*prev_ang)
                continue
            ...
            # prev = person_img
            x, y, w, h = box_info
            lin, ang = self.next_move(x, y, w, h, depth_img, lin, ang)
    ...
    def next_move(self, x, y, w, h, depth_img, lin, ang):
